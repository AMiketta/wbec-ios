...
//        UINavigationBar.appearance().backgroundColor = UIColor( Color("BackGroundColor"))
    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 16) {
               // Text("wbec").font(.largeTitle).foregroundColor(.accentColor).fontWeight(.bold)
                ...
                HStack(alignment: .center, spacing: 2){
                    ...
                    }.buttonStyle( ColorButtonStyle(color: socket.wbecState.pvMode == 1 ? .orange : .gray))
                    Spacer()
                    ...
                    }.buttonStyle(ColorButtonStyle(color: socket.wbecState.pvMode == 2 ? .orange : .gray))
                    Spacer()
                    ...
                    }.buttonStyle(ColorButtonStyle(color: socket.wbecState.pvMode == 3 ? .orange : .gray))
                }
                }
            ...
            .navigationTitle("wbec")
        }.background(Color("BackGroundColor"))
            .navigationBarColor(backgroundColor: UIColor(Color("BackGroundColor")), titleColor: .systemOrange)
